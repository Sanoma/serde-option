...
mod tests {
    ...
    fn test_ts_features() {
        ...
        #[serde_option(ts)]
        #[derive(Deserialize, Serialize, PartialEq, Debug, TS)]
        struct Example {
            normal_field: u64,
            #[nullable]
            nullable_field: Option<u64>,
            ...
            #[not_required]
            #[nullable]
            double_field: Option<Option<u64>>,
            #[not_required]
            #[nullable]
            double_field_2: Option<Option<u64>>,
        }
        let example = Example {
            normal_field: 123,
            nullable_field: None,
            ...
            double_field: None,
            double_field_2: Some(None),
        };
        assert_eq!(
            &serde_json::to_string(&example).expect("Serialization should work"),
            "{\"normal_field\":123,\"nullable_field\":null,\"double_field_2\":null}",
            "ts feature should not break serialization"
        );

        assert_eq!(
            Example::export_to_string(&ts_rs::Config::new()).expect("TS export works"),
            "// This file was generated by [ts-rs](https://github.com/Aleph-Alpha/ts-rs). Do not edit this file manually.\n\nexport type Example = { normal_field: bigint, nullable_field: bigint | null, not_required_field?: bigint, double_field?: bigint | null, double_field_2?: bigint | null, };\n"
        );
    }
}
